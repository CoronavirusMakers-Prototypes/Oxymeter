...
router.post('/', async (req, res) => {
  try {
    ...
    const response = await db.query(queries.room.create,[req.body.description, req.body.id_area])
...
router.get('/', async (req, res) => {
  try {
    ...
    const result = await db.query(queries.room.read,[offset, config.get('database.query.limit')])
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const { id } = req.params
    const result = await db.query(queries.room.update, [req.body.description, req.body.id_area, id])
