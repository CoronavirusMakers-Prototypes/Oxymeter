export const mockRoutes = {
    ...
    '/hospital/1': '/assets/mocks/hospitalIfema.json', // :id_hospital
    '/buildings/1': '/assets/mocks/buildingsIfema.json', // :id_hospital
    '/floors/1': '/assets/mocks/floorsIfema.json', // :id_building
    '/areas/1': '/assets/mocks/areasIfema.json', // :id_floor
    ...
    '/rooms/1': '/assets/mocks/roomsIfema.json',  // :id_area
    ...
    '/beds/1': '/assets/mocks/bedsIfema.json', // :id_room
    '/beds/2': '/assets/mocks/bedsIfema.json',
    '/beds/3': '/assets/mocks/bedsIfema.json',
    '/alarms/1': '/assets/mocks/alarmsSubscriptionUser1.json', // :id_user
    '/patientByIdBed/1': '/assets/mocks/patientData.json', // :id_user
    '/sensorMeassurement/453555': '/assets/mocks/meassurementsData.json', // :id_sensor
}